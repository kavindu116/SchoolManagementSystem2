...
//            System.out.println(query);
    ...
    private void initComponents() {
        ...
        roundTextField2 = new COM.DHANESH.COMPONENT.roundTextField();
        ...
        buttonGradient3.setIconTextGap(10);
                ...
                .addGroup(roundPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(roundPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(roundPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(roundPanel2Layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(roundbutton3, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(18, 18, 18)
                ...
                .addGroup(roundPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(roundPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(roundPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(buttonGradient3, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(roundPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        roundPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(roundPanel3Layout.createSequentialGroup()
                ...
                .addComponent(roundbutton2, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(21, 21, 21))
        );
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    Notifications.getInstance().show(Notifications.Type.WARNING,
                            Notifications.Location.TOP_CENTER, "Product Updated");
                }
...
//
//        textField3.setText(String.valueOf(table2.getValueAt(row, 0)));
//        textField3.setEditable(false);
//
//       textField4.setText(String.valueOf(table2.getValueAt(row, 1)));
...
//
//            if (grn != null) {
//                grn.getjTextField3().setText(String.valueOf(table2.getValueAt(row, 0)));
//                grn.getjLabel13().setText(String.valueOf(table2.getValueAt(row, 2)));
//                grn.getjLabel13().setText(String.valueOf(table2.getValueAt(row, 3)));
//                this.dispose();
//            }
//        }
    ...
    private void roundbutton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roundbutton2ActionPerformed
        ...
        try {
            MessageFormat head = new MessageFormat("Stock List");
            MessageFormat foot = new MessageFormat("page {0}");

            table2.print(JTable.PrintMode.FIT_WIDTH, head, foot);
    ...
    private COM.DHANESH.COMPONENT.roundTextField roundTextField2;
