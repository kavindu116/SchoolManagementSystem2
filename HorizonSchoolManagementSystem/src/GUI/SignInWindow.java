...
public class SignInWindow extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        jTextField1.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "User Name Hear...");
        jPasswordField1.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Password Hear...");
//        jLabel6.setText("<html><u>Login As Student</u></html>");
    ...
    private void initComponents() {
        ...
        roundPanel1 = new componet.RoundPanel();
        jLabel3 = new javax.swing.JLabel();
        jTextField1 = new javax.swing.JTextField();
        jLabel4 = new javax.swing.JLabel();
        jPasswordField1 = new javax.swing.JPasswordField();
        roundbutton1 = new componet.roundbutton();
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 10, 190, 180));
    ...
    private void roundbutton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roundbutton1ActionPerformed
        ...
        if (Uname.isEmpty()) {
            ...
            Notifications.getInstance().show(Notifications.Type.ERROR,
                    Notifications.Location.BOTTOM_LEFT, "Please Enter User Name");

        } else if (password.isEmpty()) {

            Notifications.getInstance().show(Notifications.Type.ERROR,
                    Notifications.Location.BOTTOM_LEFT, "Please Enter Your Password");
            ...
            try {
                ...
                if (resultset.next()) {
                    if (resultset.getString("employee_type.name").equals("Principal") && resultset.getString("status.name").equals("Active")) {

                        Notifications.getInstance().show(Notifications.Type.SUCCESS,
                                Notifications.Location.BOTTOM_LEFT, "Principal");

                    } else if (resultset.getString("employee_type.name").equals("Teacher") && resultset.getString("status.name").equals("Active")) {

                        Notifications.getInstance().show(Notifications.Type.SUCCESS,
                                Notifications.Location.BOTTOM_LEFT, "Teacher");

                    } else if (resultset.getString("employee_type.name").equals("Receptionist") && resultset.getString("status.name").equals("Active")) {

                        Notifications.getInstance().show(Notifications.Type.SUCCESS,
                                Notifications.Location.BOTTOM_LEFT, "Reception");

                    }
                    if (resultset.getString("employee_type.name").equals("Principal") && resultset.getString("status.name").equals("Deactive")) {

                        Notifications.getInstance().show(Notifications.Type.ERROR,
                                Notifications.Location.BOTTOM_LEFT, "You Are Inactive User Plese Contact Admin");

                    } else if (resultset.getString("employee_type.name").equals("Teacher") && resultset.getString("status.name").equals("Deactive")) {

                        Notifications.getInstance().show(Notifications.Type.ERROR,
                                Notifications.Location.BOTTOM_LEFT, "You Are Inactive User Plese Contact Admin");

                    } else if (resultset.getString("employee_type.name").equals("Receptionist") && resultset.getString("status.name").equals("Deactive")) {
                    ...
                    Notifications.getInstance().show(Notifications.Type.ERROR,
                            Notifications.Location.BOTTOM_LEFT, "invalid username or password");
    ...
    private componet.RoundPanel roundPanel1;
    private componet.roundbutton roundbutton1;
